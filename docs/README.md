...
依 **Compose 職責** 分層，左側導航為：Infrastructure、App、Media、Home stack。點入各區塊可看該類的詳細設定。
...
| [App](app/README.md) | 應用類服務（以 `docker-compose-app.yml` 管理，例如 Immich、SearXNG） |
...
- **SearXNG**：`https://search.<DOMAINNAME_1>`（僅內網）
