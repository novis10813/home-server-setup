...
| `docker-compose-app.yml` | 應用（App） | Immich、Home Assistant、Minecraft、SearXNG 等（見 `compose/apps/`） |
...
- **App** — 應用類服務（以 `docker-compose-app.yml` 管理，例如 Immich、Home Assistant、SearXNG）
